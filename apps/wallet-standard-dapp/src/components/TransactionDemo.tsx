    ...
    try {
      ...
      if (selectedToken) {
        ...
        if (amountToSend > selectedToken.amount * Math.pow(10, selectedToken.decimals)) {
          throw new Error(
            `Insufficient token balance. You have ${selectedToken.amount} ${selectedToken.symbol}`
          );
        }
        ...
        try {
          ...
          throw new Error(
            "Failed to calculate token account addresses. Please verify the recipient address."
          );
        }
          ...
          >
            <div className="flex items-center">
              ...
              <span className="ml-2">
                ...
                {selectedToken ? selectedToken.amount.toFixed(4) : balance?.toFixed(4) || "0"})
              </span>
            </div>
